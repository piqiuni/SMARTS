...
from smarts.env.gymnasium.driving_smarts_2022_env import driving_smarts_2022_env
...
def main(scenarios, headless, num_episodes, max_episode_steps=None):
    ...
    for episode in episodes(n=num_episodes):
        # agent = KeepLaneAgent()
        agent= CSTSAgent(True, True, True, False, False, True)
        # agent= CSTSAgent(True, True, False, True, True)
        ...
        terminated = False
        while not terminated and agent.timestamp < max_episode_steps:
