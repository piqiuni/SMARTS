...
# scl run --envision pi_code/test_bubble.py scenarios/sumo/loop
# scl run pi_code/test_bubble.py scenarios/sumo/loop
...
def resolve_agent_missions(
    ...
    # print(scenario.history_missions_for_window(
